...
def get_parser():
    ...
    parser.add_argument('--dt_unit', type=int, default=1)
    ...
    parser.add_argument("--lr_gamma", type=float, default=0.15)
    parser.add_argument("--save_interval", type=int, default=50)

    # how to do inference?
    parser.add_argument("--timesteps", type=int, default=300)
    parser.add_argument("--how_to_sample", type=str, default="one_step", choices=["one_step", "one_step_diff", "vdm", "next_frame", "direct"])
